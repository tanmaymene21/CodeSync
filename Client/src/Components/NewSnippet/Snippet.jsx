...
const gradients = [
  'from-rose-400 via-red-500 to-yellow-400', // Stunning sunset gradient
  'from-indigo-800 via-purple-700 to-pink-600', // Luxurious and vibrant gradient
  'from-teal-400 via-emerald-500 to-lime-600', // Fresh and natural gradient
  'from-amber-400 via-orange-500 to-rose-600', // Bold and energetic gradient
  'from-gray-900 via-neutral-600 to-gray-100', // Sleek and modern grayscale gradient
  'from-fuchsia-600 via-purple-600 to-indigo-600', // Rich and deep gradient
  'from-sky-300 via-cyan-400 to-emerald-500', // Calming and refreshing gradient
  'from-amber-200 via-yellow-400 to-lime-500', // Vibrant and playful gradient
];
...
const Snippet = () => {
  ...
  const [snippetName, setSnippetName] = useState('untitled-1');
