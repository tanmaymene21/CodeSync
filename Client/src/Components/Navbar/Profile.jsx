...
export const Profile = () => {
  ...
  useEffect(() => {
    const uniqueId = user?.email || user?.sub || 'default';
    const avatar = `https://robohash.org/${uniqueId}.png?size=100x100`;
    setAvatarUrl(avatar);
  }, []);
    ...
    <div>
      ...
      {menuOpen && (
        <ul
          ...
          className="absolute right-1 top-16 z-10 flex  flex-col gap-2 overflow-auto rounded-md border border-white/[0.2] bg-transparent backdrop-blur-md p-3 font-sans text-sm font-normal text-white shadow-md shadow-white/[0.2] focus:outline-none"
          ref={menuRef}
        >
          ...
          <button
            role="menuitem"
            className="flex w-full cursor-pointer select-none items-center gap-2 rounded-md px-2 pt-[5px] pb-1 text-start leading-tight outline-none transition-all hover:bg-blue-gray-50 hover:bg-opacity-80 hover:text-blue-gray-900 focus:bg-blue-gray-50 focus:bg-opacity-80 focus:text-blue-gray-900 active:bg-blue-gray-50 active:bg-opacity-80 active:text-blue-gray-900"
          >
            <svg
              width="16"
              height="16"
